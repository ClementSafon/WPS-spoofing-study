...
def create_dataset(radio_map: RadioMap, output_file: str):
    ...
    with open(output_file, 'w', newline='') as csvfile:
        ...
        for fingerprint in radio_map.get_fingerprints():
            ...
            row_data += [fingerprint.get_position()[0], fingerprint.get_position()[1], fingerprint.get_position()[2], fingerprint.get_building_id(), fingerprint.get_space_id(), fingerprint.get_relative_position(), fingerprint.get_user_id(), fingerprint.get_phone_id(), fingerprint.get_timestamp()]
